                                    ...
                                    value: function(t) {
                                        ...
                                        if (s(a))
                                            (a = a.map(function(t) {
                                                ...
                                                (a = this._applyNestingFormatting(
                                                    a.join(', '),
                                                    _(a)
                                                ));
                                        else {
                                            ...
                                            if (t.substr(f, c.length) === c) {
                                                ...
                                                if (i)
                                                    if (h.isSquelBuilder(d)) {
                                                        ...
                                                        ((d = this._formatValueForParamArray(
                                                            d,
                                                            o
                                                        )),
                                                        s(d))
                                                    ...
                                                    a += this._formatValueForQueryString(
                                                        d,
                                                        o
                                                    );
                                                f += c.length;
...
const getFieldValue = (t, e, r) =>
    null !== t
        ? void 0 !== r[e.value] ? e.alias : `${t}.${e.value}`
        : e.value;
class FilterString {
    ...
    _buildString(t, e, r, n, i, o, s) {
        ...
        switch (r.type) {
            ...
            default:
                a = i
                    ? this._handleLeftSide(e, r, o)
                    : this._handleText(e, r, o);
        }
        return a;
    }
...
class QueryProcessor extends Processor {
    ...
    _processTable(t, e, r, n) {
        const i = e.name;
        if (e.delete)
            throw new Error('Queries cannot contain delete statements');
        {
